...
index_binary, steps_binary = binary_search(names, target_name, 0, len(names) -1)
print(f"Binary Recursive Search: Found {target_name} at index {index_binary} in {steps_binary} steps")        